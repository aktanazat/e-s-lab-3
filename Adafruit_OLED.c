...
*/
  ...
  // set CS to low to starting reading data -> Pin 62
  MAP_SPICSEnable(GSPI_BASE);
  GPIOPinWrite(GPIOA0_BASE, 0x80, 0x00);

  // set DC to low to write command -> Pin 61
  ...
  // set CS to high to end sending data -> Pin 62
...
*/  unsigned long ulDummy;
    ...
    // set DC to high to write data -> Pin 61
